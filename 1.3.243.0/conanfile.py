...
class VulkanConan(ConanFile):
    ...
    def export_sources(self):
        ...
        copy(self, "Include/vk_video/*", self.recipe_folder, self.export_sources_folder)
        copy(self, "Include/vma/*", self.recipe_folder, self.export_sources_folder)
    ...
    def package(self):
        ...
        copy(self, "Include/vk_video/*", self.export_sources_folder, self.package_folder)
        copy(self, "Include/vma/*", self.export_sources_folder, self.package_folder)
